...
* **Localized Interface**: The user interface is available in multiple languages including English, German, Spanish, French, Portuguese, Korean, Norwegian, Czech, Simplified Chinese, Russian, Dutch, Japanese, Hindi, Arabic, and Bengali. The application automatically detects your browser's language.
